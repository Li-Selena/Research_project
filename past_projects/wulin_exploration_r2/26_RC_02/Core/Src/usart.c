...
/* USER CODE BEGIN 0 */
#ifndef UART7_IMU_BAUDRATE
#define UART7_IMU_BAUDRATE 115200U
#endif

#ifndef L1S_UART_BAUDRATE
#define L1S_UART_BAUDRATE 115200U
#endif

#ifndef L1S_UART9_BAUDRATE
#define L1S_UART9_BAUDRATE 115200U
#endif
...
void MX_UART7_Init(void)
{
  ...
  huart7.Init.BaudRate = UART7_IMU_BAUDRATE;
...
void MX_UART8_Init(void)
{
  ...
  huart8.Init.BaudRate = L1S_UART_BAUDRATE;
...
void MX_UART9_Init(void)
{
  ...
  huart9.Init.BaudRate = L1S_UART9_BAUDRATE;
...
void MX_USART1_UART_Init(void)
{
  ...
  huart1.Init.BaudRate = L1S_UART_BAUDRATE;
